...
public class LoginController {
    ...
    public void saveLogin(String user, String password) {
        ...
        String path = "C:\\Users\\uillia\\Documents\\NetBeansProjects\\ControlePedidos\\dados\\usuario.txt";
        fm.Write(path, "" + user + "");
        path = "C:\\Users\\uillia\\Documents\\NetBeansProjects\\ControlePedidos\\dados\\senha.txt";
